...
Revision ID: ab5978f563f2
Revises: 
Create Date: 2025-10-13 13:12:33.022001
...
def upgrade():
    ...
    sa.Column('printer_settings', sa.JSON(), nullable=True),
    sa.Column('barcode_scanner_type', sa.String(length=20), nullable=True),
    ...
    sa.Column('stock_alert', sa.Integer(), nullable=True),
